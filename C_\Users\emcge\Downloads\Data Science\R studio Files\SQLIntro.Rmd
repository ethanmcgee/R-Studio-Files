...
```{sql connection=conn}
select DISTINCT P.pres, P.state, S.pop
from presidents P, states S
...
```{sql connection=conn}
select DISTINCT P.pres, P.state, P.party, S.pop
from presidents P, states S
where party = 'DEMOCRAT'
```
...
```{sql connection=conn}
select P.pres, P.state, E.presvotes
from presidents P, elections E
where presvotes < 20
```
...
```{sql connection=conn}
select DISTINCT P.pres, P.state, E.year
from presidents P, elections E
